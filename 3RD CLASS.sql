...
insert into test8 ( test_id , test_name , test_mailid , teast_adress,test_salary) values (103 , 'sudhanshu','sudhanshu5@ineuron.ai','bengalore' , 50000)

insert into test8 ( test_name , test_mailid , teast_adress,test_salary) values ('sudhanshu','sudhanshu80@ineuron.ai','bengalore' , 50000)