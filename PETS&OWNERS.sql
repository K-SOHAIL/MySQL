--anand_jha_pet&owners--

"SNOWFLAKE"-- sql date functions
...
SELECT QUARTER(TO_DATE('2022-08-30')); 
...
SELECT TO_CHAR(TO_DATE('1993-08-17'),'YYYY') AS DATE;

SELECT TO_CHAR(TO_DATE('1993-08-17'),'MMMM') AS DATE;

SELECT TO_CHAR(TO_DATE('1993-08-17'),'DY-MM') AS DATE;

SELECT TO_CHAR(TO_DATE('1993-08-17'),'DY-MMMM-YYYY') AS DATE;
...
--------DATE DIFFERNOR BETWEEN FIRST AND 
select datediff('day', '2022-06-01','2023-07-19');
