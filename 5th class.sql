...
select add_to_col(quantity) from sales
...
select profit , discount , final_profits_real(profit , discount , sales) from sales
...
select quantity, int_to_str1(quantity) from sales ;
...
select sales , mark_sales2(sales) from sales ;
