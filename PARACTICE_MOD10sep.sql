"DEMODATABASE"."PUBLIC"."HEALTHCARE""DEMODATABASE"."PUBLIC""DEMODATABASE"."PUBLIC"CREATE DATABASE PARACTICE_MOD
...
SELECT * FROM EMPLOYEE "DEMODATABASE"."PUBLIC"."HEALTHCARE"
...
INSERT INTO EMPLOYEE
VALUES(112,'Masood Sohail','Associate',75000)

INSERT INTO EMPLOYEE
VALUES(113,'Bajrang Tailor','Analyst',80000)

INSERT INTO EMPLOYEE
VALUES(114,'Md Wasim','Analyst',6500)

DELETE FROM EMPLOYEE WHERE EMPID = 110;

SELECT * FROM EMPLOYEE;

update employee set job_role='Data Scientist'
where empid=102;
...
select *,row_number() from EMPLOYEE;
...
FROM EMPLOYEE 
 ...
 CREATE OR REPLACE PROCEDURE employee_insert(EMP_NAME varchar)  
RETURNS VARCHAR 
LANGUAGE JAVASCRIPT  
AS  
$$  
var command = "INSERT INTO Employee ( emp_name) VALUES ( '"+NAME+"')";  
